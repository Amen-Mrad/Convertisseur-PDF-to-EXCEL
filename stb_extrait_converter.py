        ...
        try:
            ...
            if not self.is_stb_extrait_pdf(self.pdf_file_path.get()):
                messagebox.showwarning("Attention",
                    "Ce fichier ne semble pas être un EXTRAT STB Bank.\n"
            ...
            if not transactions:
                messagebox.showerror("Erreur", "Aucune transaction trouvée dans le PDF STB Extrait")
                return
            ...
            success_msg = f"✅ Conversion STB Extrait terminée avec succès !\n\n"
