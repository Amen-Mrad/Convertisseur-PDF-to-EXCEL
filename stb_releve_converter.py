...
class STBReleveConverter:
            ...
            with pdfplumber.open(pdf_path) as pdf:
                ...
                for page_num in range(min(3, len(pdf.pages))):
                    ...
                    if text:
                        ...
                        if found_keywords >= 3:  # Au moins 3 mots-clés STB
                            return True
                return False
        ...
        try:
            ...
            with pdfplumber.open(pdf_path) as pdf:
                ...
                for page_num, page in enumerate(pdf.pages):
                    print(f"DEBUG STB - Page {page_num + 1}")
                    ...
                    if not text.strip() and page_num == 0:
                        ...
                        if ocr_text.strip():
                            ...
                            return self._parse_ocr_text_stb(ocr_text, year)
                    
                    # Extraire les tableaux de la page
                    tables = page.extract_tables()
                    print(f"DEBUG STB - {len(tables)} tableaux trouvés")
                    ...
                    for table_idx, table in enumerate(tables):
                        if table and len(table) > 1:  # Au moins un en-tête et des données
                            ...
                            if header_row is not None:
                                ...
                                print("DEBUG STB - Aucun en-tête trouvé")
    ...
    def convert_pdf_to_excel(self):
        ...
        try:
            ...
            if not self.is_stb_releve_pdf(self.pdf_file_path.get()):
                messagebox.showwarning("Attention",
                    "Ce fichier ne semble pas être un RELEVE STB Bank.\n"
            ...
            if not transactions:
                messagebox.showerror("Erreur", "Aucune transaction trouvée dans le PDF STB")
                return
            ...
            success_msg = f"✅ Conversion STB terminée avec succès !\n\n"
