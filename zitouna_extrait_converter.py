...
class ZitounaExtraitConverter:
    ...
    def convertir(self):
        ...
        if not path or not os.path.exists(path):
            messagebox.showwarning("PDF manquant", "Veuillez choisir un fichier PDF ZITOUNA EXTRAT.")
            return
        ...
        if not rows:
            messagebox.showerror("Aucune transaction", "Impossible d'extraire des transactions de l'extrait ZITOUNA.")
            return
