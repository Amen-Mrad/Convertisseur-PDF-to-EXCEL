...
class AmenReleveConverter:
    ...
    def convertir(self):
        ...
        if not path or not os.path.exists(path):
            print("⚠️ PDF manquant - Veuillez choisir un fichier PDF AMEN.")
            return
        ...
        if not rows:
            print("❌ Aucune transaction - Impossible d'extraire des transactions du relevé AMEN.")
            return
        ...
        print(f"✅ Conversion RELEVE terminée avec succès !")
